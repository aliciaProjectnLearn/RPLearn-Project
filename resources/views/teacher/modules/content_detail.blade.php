    ...
    <div class="rg-course-container">
        ...
        <div class="rg-sidebar">
            ...
            @foreach($playlist as $item)
                ...
                <a href="{{ route('teacher.modules.content.show', $item->id) }}"
        ...
        <div class="rg-main">
            ...
            <div class="rg-header">
                ...
                <div class="rg-actions">
                    ...
                    <a href="{{ route('teacher.modules.content.edit', $content->id) }}"
                       class="btn-rg edit">
                        ✏️ Edit
                    </a>

                    <form action="{{ route('teacher.modules.content.destroy', $content->id) }}"
                          method="POST"
            ...
            <div class="rg-card">
                ...
                <div class="rg-nav-buttons">
                    ...
                    @if($prev)
                        <a href="{{ route('teacher.modules.content.show', $prev->id) }}"
                        class="btn-rg nav">
                            ⬅️ Sebelumnya
                        </a>
                    @endif
                    ...
                    @if($next)
                        <a href="{{ route('teacher.modules.content.show', $next->id) }}"
                ...
                {{-- BACK --}}
                <a href="{{ url()->previous('teacher.modules.add_content') }}" class="btn-rg back">
                    ⬅ Kembali
                </a>
